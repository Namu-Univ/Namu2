...
--강의 테이블 타입 변경
ALTER TABLE SUBJECT MODIFY NAME VARCHAR2(40);
...
CREATE TABLE GRADE (
	...
	ABSENT	NUMBER(5)		NOT NULL,
	MIDTERM	NUMBER(5)		NOT NULL,
	FINAL	NUMBER(5)		NOT NULL,
	EX_SCORE	NUMBER(5)		NOT NULL,
...
ALTER TABLE "GRADE" ADD CONSTRAINT "FK_SUBJECT_TO_GRADE_1" FOREIGN KEY (
	"SUB_ID"
)
REFERENCES "SUBJECT" (
	"ID"
...
ALTER TABLE GRADE RENAME COLUMN FINAL TO FIN_EXAM;
ALTER TABLE GRADE RENAME COLUMN MIDTERM TO MID_EXAM;
ALTER TABLE NOTICE ADD FILE_NAME VARCHAR2(255);
...
ALTER TABLE "ENROLMENT" ADD CONSTRAINT "FK_STUDENT_TO_ENROLMENT_1" FOREIGN KEY (
	"STU_ID"
)
REFERENCES "STUDENT" (
	"ID"
...
ALTER TABLE "ENROLMENT" ADD CONSTRAINT "FK_SUBJECT_TO_ENROLMENT_1" FOREIGN KEY (
	"SUB_ID"
)
REFERENCES "SUBJECT" (
	"ID"
